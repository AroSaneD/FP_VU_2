...
/* package FPTicTacToeAS-0.1.0.0 */
#define VERSION_FPTicTacToeAS "0.1.0.0"
#define MIN_VERSION_FPTicTacToeAS(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "FPTicTacToeAS-0.1.0.0-15DeWN58X9u4Tn9Pl6LUf"

#define CURRENT_PACKAGE_KEY "FPTicTacToeAS-0.1.0.0-15DeWN58X9u4Tn9Pl6LUf"
